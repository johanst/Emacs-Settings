...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rust-mode go-mode meson-mode typescript-mode markdown-mode json-mode adoc-mode plantuml-mode zenburn-theme pyvenv protobuf-mode magit key-chord clang-format ace-jump-mode ac-etags)))
