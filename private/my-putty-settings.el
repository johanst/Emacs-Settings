...
(if (eq system-uses-terminfo t)
    (progn ;; PuTTY hack - needs to be in XTerm XFree86 mode
      ...
      ;; f12
      (define-key input-decode-map "\e[23~" [f12])
      (define-key input-decode-map "\e[23;2~" [S-f12])
      (define-key input-decode-map "\e[23;3~" [M-f12])
      (define-key input-decode-map "\e[23;4~" [S-M-f12])
      (define-key input-decode-map "\e[23;5~" [C-f12])
      (define-key input-decode-map "\e[23;6~" [S-C-f12])
      (define-key input-decode-map "\e[23;7~" [M-C-f12])
      (define-key input-decode-map "\e[23;8~" [S-M-C-f12])))
